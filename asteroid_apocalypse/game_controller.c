...
double left_led_timer;
bool flash_right_led = false;
double right_led_timer;
...
void left_LED_flash(double start_time){
    double left_led_timer = get_elapsed_time();
    int count = 0;

    
        double diff = get_elapsed_time() - left_led_timer;
...
void right_LED_flash(){
    ...
    while(1){
        double diff = get_elapsed_time() - start_time;
